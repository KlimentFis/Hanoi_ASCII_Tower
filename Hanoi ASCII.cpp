...
void hanoi(int n, int i, int k, int disk)
{
    ...
    if (n == 1)
    {
        std::cout << "Переместите 1 диск с " << i << " на " << k << " башню" << std::endl;
        std::cout << std::endl;
        move(i, k);
        show(disk);
        getchar();
...
int main()
{
    ...
    std::cout << "Введите количество дисков в Ханойской башне: " << std::endl;int disk;std::cin >> disk;    
    std::cout << "Введите стартовую позицию Ханойской башни: " << std::endl;int start; std::cin >> start;
    switch (start)
    {
    case 1:
    ...
    std::cout << "Введите конечную позицию Ханойской башни: " << std::endl;int end; std::cin >> end;
    system("cls");
